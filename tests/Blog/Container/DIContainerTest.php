...
use Geekbrains\App\Blog\Exceptions\NotFoundException;
use Geekbrains\App\Blog\Repositories\UsersRepository\InMemoryUsersRepository;
...
class DIContainerTest extends TestCase
{
    public function testItThrowsAnExceptionIfCannotResolveType(): void
    {
        ...
        $this->expectExceptionMessage(
            'Cannot resolve type: Geekbrains\App\UnitTests\Blog\Container\SomeClass'
        );
